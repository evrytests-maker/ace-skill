...
**П.5. Нет нарративного барохла.** 100–200 слов на стартовое сообщение. Не расписывай запах мокрого асфальта и переливы неоновых вывесок. Каждое предложение — факт или триггер для ответа модели.
...
**F.1. Длина: 100–200 слов.** Не больше. Модель должна быстро втянуться.
...
| 6 | **first_mes > 400 слов** | Пользователь теряет интерес | 100–200 слов, хук + действие + речь |
...
- [ ] first_mes: 100–200 слов, хук + действие + речь
